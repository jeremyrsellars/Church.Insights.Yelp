...
Accounting for the popularity of Yelp over time, the the following diagram shows the percentage of yelp reviews for churches.

### Church reviews over time

```{r churches_vs_world_data, echo=F, cache=T}
quarterly_reviews <-
...
`r kable(quarterly_average[,c("Quarter","PerMillion","Percentage")])`
